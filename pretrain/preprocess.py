...
def main():
    ...
    parser.add_argument('--train_corpus', type=Path, default=r'/data/tmp/ch/ABSA_bert/pretrain/data_humor/en_pretrain.txt')
    # parser.add_argument("--output_dir", type=Path, default='ERNIE_cn_0730_TD')
    parser.add_argument("--output_dir", type=Path, default='bert_base_uncased_0730_TD')
    # parser.add_argument("--output_dir", type=Path, default='bert_base_uncased_0730_DAPT')
    ...
    parser.add_argument("--do_whole_word_mask", action="store_true", default=False,   #*
